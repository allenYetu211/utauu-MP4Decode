...
import MP4Box from './demo-mp4boxjs/index';

const url = "https://devcdn.xylink.com/video-tset/test.mp4";
...
function initializeSegmentation(mp4file) {
  console.log('initializeSegmentation')
  // console.log('initializeSegmentation',  mp4file.initializeSegmentation())
